...
function merge(collection1, collection2, collection3) {
    ...
    while (i < collection1.length || j < collection2.length || k < collection3.length) {
        ...
        const minValue = Math.min(i < collection1.length ? collection1[i] : Infinity, j < collection2.length ? collection2[j] : Infinity, k < collection3.length ? collection3[collection3.length - 1 - k] : Infinity);
